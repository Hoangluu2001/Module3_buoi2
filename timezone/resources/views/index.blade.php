<div class="main-content" >
    <h1>Ứng dụng xem giờ hiện tại của các thành phố trên thế giới Lớn Như Nghệ An</h1>
    ...
    <select id="select-city">
        ...
        <option value="Asia-Ho_Chi_Minh">Hà Nội</option>
        <option value="Asia-Ho_Chi_Minh">Nghệ An</option>
    </select>
</div>
