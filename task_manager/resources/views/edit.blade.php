...
{{--    <h1><span>t</span>ransitive <span>r</span>egister <span>f</span>orm</h1>--}}
    <h1><span>C</span>hỉnh <span>S</span>ủa <span>T</span>hông  <span>T</span>in  <span>K</span>hách  <span>H</span>àng</h1>
</div>
    ...
    <div class="agile-right">
        <form action="#" method="post" enctype="multipart/form-data">
            ...
            <div class="agile-right-h2">
                <h2>Thông Tin Khách Hàng Cần Sửa</h2>
            </div>
            <div class="w3l-name">
            ...
            <div class="w3l-email">
                <span><i class="fa fa-user" aria-hidden="true"></i></span>
                <input style="letter-spacing: 2px;border: none;outline: none; width: 90% ;height: 90%" type="number" name="age" value="{{$customer->age}}"required=""/>
            </div>
            <div class="clear"></div>
            <div class="w3l-psw">
                <span><i class="fa fa-user" aria-hidden="true"></i></span>
                <input style="letter-spacing: 2px;border: none;outline: none; width: 90% ;height: 90%" type="number" name="phone" value="{{$customer->age}}" required=""/>
            </div>
            <div class="clear"></div>
            <div class="w3l-cpsw">
                <span><i class="fa fa-envelope" aria-hidden="true"></i></span>
                <input style="letter-spacing: 2px;border: none;outline: none; width: 90% ;height: 90%" type="email" name="email" value="{{$customer->email}}" required=""/>
            </div>

            <div class="w3l-cpsw">
                <span><i class="fa fa-user" aria-hidden="true"></i></span>
                <input style="letter-spacing: 2px;border: none;outline: none; width: 90% ;height: 90%" type="text" name="address" value="{{$customer->address}}" required=""/>
            </div>
